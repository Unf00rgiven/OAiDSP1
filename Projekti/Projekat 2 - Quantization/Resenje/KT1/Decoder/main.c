...
void main( void )
{
    ...
    aic3204_set_input_filename("../../huffman/out_Zadatak1-3.dsp1");				// SIGNAL DOBIJEN PRIMENOM HOFMANOVOG DEKODOVANJA
	aic3204_set_output_filename("../out_Zadaatak1-3.wav");							// IZLAZNI SIGNAL
