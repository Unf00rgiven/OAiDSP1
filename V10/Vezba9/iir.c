...
Int16 fourth_order_IIR(Int16 input, Int16 coefficients[][6], Int16 x_history[][3],
		Int16 y_history[][3]) {
	Uint32 accum;
	Int16 temp;
	Uint16 stage;
...
Int16 Nth_order_IIR(Int16 input, Int16 coefficients[][6], Int16 z_x[][3],
		Int16 z_y[][3], Int16 order) {
